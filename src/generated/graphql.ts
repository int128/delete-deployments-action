...
export type GetDeploymentsQuery = { __typename?: 'Query', rateLimit?: { __typename?: 'RateLimit', cost: number } | null, repository?: { __typename?: 'Repository', deployments: { __typename?: 'DeploymentConnection', totalCount: number, nodes?: Array<{ __typename?: 'Deployment', id: string, databaseId?: number | null, environment?: string | null, state?: Types.DeploymentState | null, ref?: { __typename: 'Ref' } | null } | null> | null } } | null };
